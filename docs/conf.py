...
"""
operation-event documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'operation-event',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/zi-eum/operation-event",
...
#
# html_title = 'operation-event v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'operation_event'),
                os.path.join(root_path, 'operation_event/migrations')])
