#!/usr/bin/env python
"""
Package metadata for operation_event.
"""
import os
import re
import sys
...
VERSION = get_version('operation_event', '__init__.py')
...
setup(
    ...
    author='zi-eum',
    author_email='dukhoon.kang@gmail.com',
    url='https://github.com/zi-eum/operation-event',
    packages=find_packages(
        include=['operation_event', 'operation_event.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "operation_event = operation_event.apps:OperationEventConfig",
        ],
        "cms.djangoapp": [
            "operation_event = operation_event.apps:OperationEventConfig",
        ],
