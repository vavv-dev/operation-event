...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd operation_event && ../manage.py makemessages -l en -v1 -d django
	cd operation_event && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd operation_event && ../manage.py compilemessages

detect_changed_source_translations:
	cd operation_event && i18n_tool changed
...
dummy_translations: ## generate dummy translation (.po) files
	cd operation_event && i18n_tool dummy
...
dev.provision.lms:
	docker exec -it edx.devstack.lms bash -c 'pip uninstall -y operation-event && pip install -e /edx/src/operation-event/'

dev.provision.cms:
	docker exec -it edx.devstack.cms bash -c 'pip uninstall -y operation-event && pip install -e /edx/src/operation-event/'

dev.provision:
	make dev.provision.lms
	make dev.provision.cms
